...
struct digitos function(int num){
    ...
    D1.digito3 = splitarray[0];
    D1.digito2 = splitarray[1];
    D1.digito1 = splitarray[2];
...
void main(void){
    ...
    tmr0_setup();
    while(1){
        struct digitos result = function(PORTA);
        display3 = tabla[result.digito3];
        display2 = tabla[result.digito2];
        display1 = tabla[result.digito1];
    }
    return;
}
